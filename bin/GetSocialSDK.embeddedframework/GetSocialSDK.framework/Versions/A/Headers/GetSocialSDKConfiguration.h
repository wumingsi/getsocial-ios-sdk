...
@interface GetSocialSDKConfiguration : NSObject
 ...
 * @param elementID The ID of the element to customise.
 */
- (void) setAnimationStyle:(GetSocialSDKAnimationStyle)style forElementID:(NSString*)elementID;
 ...
 */
- (void) setScaleMode:(GetSocialSDKScaleMode)scaleMode;
