...
@interface GetSocialSDKConfigurationProperties : NSObject

struct GetSocialSDKConfigurationPropertyStruct {
...
extern const struct GetSocialSDKConfigurationPropertyStruct Property;
